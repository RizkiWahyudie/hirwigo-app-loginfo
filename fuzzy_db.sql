...
--
-- Host: localhost:3306
-- Waktu pembuatan: 17 Des 2022 pada 10.39
...
(86, 'BTKDA', 'HRG', 19, 1, 0, 0),
(87, 'BTKDA', 'HRG', 15000, 1, 0, 0),
(88, 'BTKDA', 'JRK', 79, 0, 0, 1),
...
--
-- Indeks untuk tabel `kriteria_fuzzy`
--
...
--
-- Indeks untuk tabel `nilai_fuzzy`
--
...
--
-- AUTO_INCREMENT untuk tabel `nilai_fuzzy`
--
ALTER TABLE `nilai_fuzzy`
  MODIFY `id_nilai_fuzzy` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
COMMIT;
